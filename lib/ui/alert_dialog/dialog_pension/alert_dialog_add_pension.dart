...
class AddPension extends StatefulWidget {
  const AddPension({Key? key, required this.liveBloc}) : super(key: key);

  final LiveBloc liveBloc;

  @override
  State<AddPension> createState() => _AddPensionState(liveBloc: liveBloc);
}

class _AddPensionState extends State<AddPension> {
  ...
  _AddPensionState({required this.liveBloc});

  @override
  Widget build(BuildContext context) {
    return AlertDialog(
      insetPadding: EdgeInsets.zero,
      title: const Text('Добавить пенсионное страхование'),
      content: Column(
