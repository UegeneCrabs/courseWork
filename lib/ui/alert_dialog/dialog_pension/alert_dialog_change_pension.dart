...
class ChangePension extends StatefulWidget {
  const ChangePension({Key? key, required this.liveBloc}) : super(key: key);
  final LiveBloc liveBloc;

  @override
  State<ChangePension> createState() => _ChangePensionState(liveBloc: liveBloc);
}

class _ChangePensionState extends State<ChangePension> {
  ...
  _ChangePensionState({required this.liveBloc});

  @override
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text('Изменить пенсионное страхование'),
      content: Column(
