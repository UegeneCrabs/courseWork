...
class AddLive extends StatefulWidget {
  const AddLive({Key? key, required this.liveBloc}) : super(key: key);

  final LiveBloc liveBloc;

  @override
  State<AddLive> createState() => _AddLiveState(liveBloc: liveBloc);
}
...
class _AddLiveState extends State<AddLive> {
  ...
  _AddLiveState({required this.liveBloc});

  @override
  Widget build(BuildContext context) {
    return AlertDialog(
      insetPadding: EdgeInsets.zero,
      title: const Text('Добавить страхование Жизни'),
      content: Column(
