...
class AddAuto extends StatefulWidget {
  const AddAuto({Key? key, required this.liveBloc}) : super(key: key);

  final LiveBloc liveBloc;

  @override
  State<AddAuto> createState() => _AddAutoState(liveBloc: liveBloc);
}
...
class _AddAutoState extends State<AddAuto> {
  ...
  _AddAutoState({required this.liveBloc});

  @override
  Widget build(BuildContext context) {
    return AlertDialog(
      insetPadding: EdgeInsets.zero,
      title: const Text('Добавить страхование Автомобиля'),
      content: Column(
