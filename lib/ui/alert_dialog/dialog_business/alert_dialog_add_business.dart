...
class AddBusiness extends StatefulWidget {
  const AddBusiness({Key? key, required this.liveBloc}) : super(key: key);

  final LiveBloc liveBloc;

  @override
  State<AddBusiness> createState() => _AddBusinessState(liveBloc: liveBloc);
}
...
class _AddBusinessState extends State<AddBusiness> {
  ...
  _AddBusinessState({required this.liveBloc});

  @override
  Widget build(BuildContext context) {
    return AlertDialog(
      insetPadding: EdgeInsets.zero,
      title: const Text('Добавить страхование Бизнеса'),
      content: Column(
